  ...
  <div class="app-container">
    <el-form :inline="true" class="demo-form-inline">
      <el-form-item label="礼品名称">
        <el-input v-model="dataVo.name" placeholder="请输入礼品名称"/>
      </el-form-item>
    ...
    >
      ...
      <el-table-column prop="description" label="礼品描述"/>
    ...
    >
      <el-form :model="formData" label-position="left" label-width="100px">
        <el-form-item label="礼品名称">
          <el-input v-model="formData.name" placeholder="请填写礼品名称"/>
        </el-form-item>
        <el-form-item label="礼品描述">
          <el-input  type="textarea"
                    :rows="2" v-model="formData.description" placeholder="请填写礼品描述"/>
        </el-form-item>
        <el-form-item label="所需积分">
          <el-input-number v-model="formData.point"/>
        </el-form-item>
        <el-form-item label="库存">
          <el-input-number v-model="formData.store"/>
        </el-form-item>
