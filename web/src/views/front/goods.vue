          ...
          <el-card>
            ...
            <div style="padding: 10px 0">
              <div style="margin-bottom: 20px">
                <el-input placeholder="输入搜索的兑换礼品名称" style="width: 30%" v-model="searchText"></el-input>
...
export default {
  ...
  methods: {
    goodsDetail(id) {
      this.$router.replace({path: '/front/goodsDetail', query: {id: id}})
    },
    loadTable() {
      API.get("/userWeb/getGoods", {
        params: {
