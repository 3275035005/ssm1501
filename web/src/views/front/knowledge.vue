          ...
          <el-card>
            ...
            <div style="padding: 10px 0">
              <div style="margin-bottom: 20px">
                <el-input placeholder="输入搜索的垃圾分类知识标题" style="width: 30%" v-model="searchText"></el-input>
              ...
              <el-row :gutter="10">
                <el-col :span="6" v-for="item in tableData" :key="item.id" style="margin-bottom: 10px">
                  <div style="border: 1px solid #ccc; padding: 10px; cursor: pointer" @click="knowledgeDetail(item.id)">
...
export default {
  ...
  methods: {
    knowledgeDetail(id) {
      this.$router.replace({path: '/front/knowledgeDetail', query: {id: id}})
    },
    loadTable() {
      API.get("/userWeb/getKnowledge", {
        params: {
