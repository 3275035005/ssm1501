<template>
  <div>
    ...
    <div style="width: 100%; height: 60px; line-height: 60px; background-color: white">
      <el-row>
        <el-col :span="4">
          <div style="font-size: 20px; font-weight: bold; text-align: center"><a style="color: #409EFF;" href="/front/home">垃圾分类管理系统</a></div>
        </el-col>
        <el-col :span="10">
          <el-menu class="side-menu" :default-active="$route.path" @select="handleMenuSelect" mode="horizontal">
            ...
            <el-menu-item index="/front/recognition">
              上传垃圾识别
            </el-menu-item>
            <el-menu-item index="/front/goods">
              兑换礼品
            </el-menu-item>
        ...
        <el-col :span="6">
          <div v-if="!$route.path.includes('/search')">
            <el-input style="width: 80%" placeholder="请输入垃圾分类信息" v-model="searchText"></el-input>
